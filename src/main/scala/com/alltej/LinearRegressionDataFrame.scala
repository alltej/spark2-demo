...
object LinearRegressionDataFrame {
  ...
  def main(args: Array[String]) {
    ...
    //val lines = spark.sparkContext.textFile(getClass.getResource("/fakefriends.csv").toString)
    val inputLines = spark.sparkContext.textFile(getClass.getResource("/regression.txt").toString)
